    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-9 col-md-8 col-sm-8 col-xs-12 main-content-area">
                ...
                @else
                    <p style="padding-top: 30px;">No products according to your search !</p>
                @endif
                        ...
                        <ul class="products">
                            ...
                            <li class="product-item">
                                <div class="product product-widget-style">
                                    ...
                                    <div class="product-info">
                                        <a href="{{route('product.details',['slug'=>$p_product->slug])}}" class="product-name"><span>{{$p_product->short_description}}</span></a>
